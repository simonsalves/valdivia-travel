...
<p class="step"><a href="setup-config.php?step=1<?php if ( isset( $_GET['noapi'] ) ) echo '&amp;noapi'; ?>" class="button">¡Comencemos!</a></p>
<?php
	break;
...
<?php
		...
		display_header();
?>
<p>¡Listoco! Ya terminamos esta parte de la instalación. Ahora WordPress puede comunicarse con tu base de datos. Si estás preparado es momento de &hellip;</p>
